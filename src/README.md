...
# 5. Fix storage & cache permissions (required for Laravel to compile views)
...
- [x] Phase 2 — Laravel backend architecture (Services, Repositories, Auth)
- [x] Phase 3 — API layer (endpoints, Cloudinary, SendGrid)
